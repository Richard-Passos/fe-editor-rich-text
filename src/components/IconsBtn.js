        ...
        <div className={styles.alignPadding}>
          <section className={styles.sectionBtns}>
            ...
            <button
              onClick={() => {
                const iframe = document.querySelector("iframe");
                iframe.contentDocument.execCommand("strikethrough");
              }}
              className={styles.btn}
            >
          ...
          <section className={styles.sectionBtns}>
            <button
              onClick={() => {
                const iframe = document.querySelector("iframe");
                iframe.contentDocument.execCommand("justifyLeft");
              }}
              className={styles.btn}
            >
            ...
            <button
              onClick={() => {
                const iframe = document.querySelector("iframe");
                iframe.contentDocument.execCommand("justifyRight");
              }}
              className={styles.btn}
            >
            ...
            <button
              onClick={() => {
                const iframe = document.querySelector("iframe");
                iframe.contentDocument.execCommand("justifyCenter");
              }}
              className={styles.btn}
            >
            ...
            <button
              onClick={() => {
                const iframe = document.querySelector("iframe");
                iframe.contentDocument.execCommand("justifyFull");
              }}
              className={styles.btn}
            >
